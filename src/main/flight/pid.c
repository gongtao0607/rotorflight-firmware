...
static void pidApplyOffsetBleed(const pidProfile_t * pidProfile)
{
    ...
    // Bleed variables
    float bleedRate = pidTableLookup(Cx, pidProfile->offset_bleed_rate_curve, LOOKUP_CURVE_POINTS) * 0.04f * 3;
    float bleedLimit = pidTableLookup(Cx, pidProfile->offset_bleed_limit_curve, LOOKUP_CURVE_POINTS) * 3;
