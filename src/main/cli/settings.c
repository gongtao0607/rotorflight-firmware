...
// PG_MIXER_CONFIG
    ...
    { "collective_scale_beta_pos",  VAR_UINT8  | MASTER_VALUE,  .config.minmax = { 0, 100 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, collective_scale_beta_pos) },
    { "collective_scale_beta_neg",  VAR_UINT8  | MASTER_VALUE,  .config.minmax = { 0, 100 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, collective_scale_beta_neg) },
...
// PG_PID_PROFILE
    ...
    { "setpoint_booset_cutoff",     VAR_UINT8  | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 3, PG_PID_PROFILE, offsetof(pidProfile_t, setpoint_boost_cutoff) },
