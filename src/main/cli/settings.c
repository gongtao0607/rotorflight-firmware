...
// PG_MIXER_CONFIG
    ...
    { "alpha_pos",                  VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 100 }, PG_PID_PROFILE, offsetof(mixerConfig_t, alpha_pos) },
    { "alpha_neg",                  VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 100 }, PG_PID_PROFILE, offsetof(mixerConfig_t, alpha_neg) },
